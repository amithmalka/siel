  ...
  return (
    <main className="min-h-screen bg-cream flex flex-col items-center justify-center p-6" dir="rtl">
      <div className="w-full max-w-lg">
        ...
        {allDone && (
          <Link href="/beauty" className="block mt-6 w-full bg-pink text-white text-center font-semibold py-3 rounded-xl hover:opacity-90 transition-opacity">
            סיימתי — כניסה לדאשבורד ←
          </Link>
        )}
